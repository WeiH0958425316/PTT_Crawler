...
#### 
#### Introduce-------------------------------
#### *ptt_crawler_download:抓取並直接下載至指定資料夾
#### *ptt_crawler_list:抓取彙整為list
#### 
#### @@@@------------------------------------
...
### 控制列: 目標設定----
# search_board <- "Lifeismoney"
# # search_board <- "hypermall"
# search_range <- 2
# search_keyword <- c("大潤發", "家樂福", "全聯", "愛買", "屈臣氏", "美廉社", "頂好", "全家", "7-11|小七|小7", "大賣場", "量販")
